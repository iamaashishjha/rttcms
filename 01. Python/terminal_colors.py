class TerminalColors:
    ...
    def get_color(name: str) -> str:
        """
        Retrieve the ANSI escape code for a given color name.
        Defaults to RESET if the color name is not found.
        """
        # Use class reference to access COLOR_MAP
        return TerminalColors.COLOR_MAP.get(name.lower(), TerminalColors.RESET)
